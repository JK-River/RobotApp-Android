...
public class MultiGLVideoView extends GLView {

	private static final String TAG = "MultiGLVideoView";
	...
	public MultiGLVideoView(Context context, GraphicRendererMgr graphicRenderMgr) {
		mContext = context;
...
//			AVEndpoint endpoint = qavsdk.getRoom().getEndpointById(mIdentifier);
//			if(endpoint == null) {
//				return;
//			}
//			AVEndpoint.Info info = endpoint.getInfo();
//			if(info.terminalType == AVEndpoint.Info.AVTerminal_iPhone) {
//				rotation = 2;
//			}
...
//			Log.d("machao", "render rotation:" + rotation + "|mirror" + mMirror);
			mYuvTexture.draw(canvas, 0, 0, uiWidth, uiHeight);
			canvas.restore();
		}
		// render loading
	...
	public void setRotation(int rotation) {
		Log.d("machao", this + "setRotation:" + rotation);
