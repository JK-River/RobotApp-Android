...
public class MultiVideoMembersControlUI extends RelativeLayout {
	...
	private static final String TAG = "MultiVideoMemsControlUI";
	...
	private MultiQavsdkControl mQavsdkControl = null;
	...
	private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals(MultiUtil.ACTION_MEMBER_CHANGE)) {
	...
	public MultiVideoMembersControlUI(Context context, AttributeSet attrs) {
		...
		mQavsdkControl = ((RobotApplication) getContext().getApplicationContext()).getMultiQavsdkControl();
	}
	...
	private void initParas() {
		...
		ArrayList<MultiMemberInfo> membersList = mQavsdkControl.getMemberList();
	...
	private void initModeAndMaxPageNum() {
		int screenHeight = MultiUtil.getScreenHeight(getContext());
	...
	private void adapterPageSize() {
		...
		int screenwidth = MultiUtil.getScreenWidth(getContext());
	...
	public void notifyDataSetChanged(ArrayList<MultiMemberInfo> friends) {
	...
	private Bitmap getDefaultBitmap() {
		Drawable temp = mResources.getDrawable(R.drawable.video_default_head);
	...
	private class GridViewBaseAdapter extends BaseAdapter {
		...
		private View getView(int position, View convertView, int type) {
			...
			int displayPos = position + this.pageIndex * mMaxPageNum;
			ArrayList<MultiMemberInfo> membersList = mQavsdkControl.getMemberList();
			MultiMemberInfo friend = membersList.get(displayPos);
		...
		private View assembleConvertView(View view, MultiMemberInfo info,
				boolean isSelected) {
	...
	private OnItemClickListener mItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			ArrayList<MultiMemberInfo> membersList = mQavsdkControl.getMemberList();
			MultiMemberInfo info = membersList.get(index);
			if (info.hasCameraVideo)
			{
	...
	protected void onAttachedToWindow() {
		...
		if (!mAttached) {
			...
			filter.addAction(MultiUtil.ACTION_MEMBER_CHANGE);
