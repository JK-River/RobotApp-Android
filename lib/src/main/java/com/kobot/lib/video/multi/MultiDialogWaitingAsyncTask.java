...
public class MultiDialogWaitingAsyncTask extends AsyncTask<Integer, Integer, String> {
	private static final String TAG = "MultiDialogWaitingAsyncTask";
	private ProgressDialog mDialogWaiting = null;
	private long mStartTime;
	private int mMaxSenconds;

	public MultiDialogWaitingAsyncTask(ProgressDialog progressDialog) {
		super();
