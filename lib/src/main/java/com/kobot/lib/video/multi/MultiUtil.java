...
public class MultiUtil {
	...
	private static final String PACKAGE = "com.kobot.xiaoyi";
	 ...
	 * 从avActivity返回
	 */
	public static final String ACTION_AV_ACTIVITY_FINISH = PACKAGE
			+ ".ACTION_AV_ACTIVITY_FINISH";

	/**
	 * 等待页finish
	 */
	public static final String ACTION_PERSON_TALK_FINISH = PACKAGE
			+ ".ACTION_PERSON_TALK_FINISH";

	/**
	 * 成功创建房间
	 */
	public static final String ACTION_CREATE_ROOM_SUCCESS = PACKAGE
			+ ".ACTION_CREATE_ROOM_SUCCESS";

	/**
	 * 进入通话页面
	 */
	public static final String ACTION_JUMP_TO_VIDEOING = PACKAGE
			+ ".ACTION_JUMP_TO_VIDEOING";

	/**
	 * toggle 控制按钮
	 */
	public static final String ACTION_TOGGLE_CONTROL_BARS = PACKAGE
			+ ".ACTION_TOGGLE_CONTROL_BARS";

	/**
	 * toggle 控制按钮
	 */
	public static final String ACTION_CAPTURE_COMPLETE = PACKAGE
	...
	public static final String EXTRA_IS_MONITOR = "isMonitor";
	public static final String EXTRA_TO_CONTINUE = "toContinue";     //已经处于通话状态
	...
	public static final String EXTRA_IS_ROBOT = "is_robot";
